...
public abstract class Usuario {
	...
	/*
	 * public String get_Apellido1() { return _apellidos[0]; }
	 * 
	 * public String get_Apellido2() { return _apellidos[1]; }
	 */
	...
	/*
	 * public List<Tupla> getTupla() { return this._tupla; }
	 * 
	 * public void añadirTupla(Tupla tupla,boolean alumno) { int i=0; boolean existe
	 * = false, asigRep = false; while(i < _tupla.size() && !existe && !asigRep) {
	 * if(_tupla.get(i).equals(tupla)) { existe = true;
	 ...
	 * asigRep = true; ViewUtils.
	 * showErrorMsg("No puedes estar en dos grupos de la misma asigantura a la vez"
	 * ); } i++; } if(!existe && !asigRep) { _tupla.add(tupla); } }
	 * 
	 * public void quitarTupla(Tupla tupla) { _tupla.remove(tupla); }
	 */
