...
public class InfoAsignatura extends JFrame {
	...
	private void initGUI() {
		...
		if (_asignatura.getGrupos().isEmpty()) {
			JLabel sinGruposLabel = new JLabel(
					"La asignatura de " + _asignatura.getNombre() + " no tiene grupos asociados.");
			...
			for (Grupo g : _asignatura.getGrupos()) {
				Object[] row = { String.valueOf(g.get_nombre()) }; // Convertimos el char a String y lo pasamos como
																	// Object[]
