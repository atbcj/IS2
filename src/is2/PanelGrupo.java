 ...
 * @author stele
 */
public class PanelGrupo extends javax.swing.JDialog {
     ...
     */
    public PanelGrupo(java.awt.Frame parent, boolean modal,Controller control, String nombre) {
        super(parent, modal);
        _ctrl = control;
        _nombre = nombre;
        initComponents();
    ...
    private void initComponents() {
        ...
        asignaturasText = new JTextField();
        
        
        saveButton = new JButton();
        saveButton.setText("save");
        saveButton.addActionListener((e) -> creaGrupo());
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(asignaturasText, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(asignaturasLabel)
                    .addComponent(asignaturasText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelGrupo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private JTextField asignaturasText;
    ...
    void creaGrupo() {
    	_ctrl.altaGrupo(titulacionText.getText(), " ", asignaturasText.getText(), _nombre);
    }
}
